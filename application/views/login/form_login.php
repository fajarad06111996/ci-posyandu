...
<html lang="en">
<head>
	<title>SISTEM INFORMASI E POSYANDU</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url(); ?>assets_login/images/bg.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url("app/loginadmin"); ?>" method="post">
					<span class="login100-form-logo">
						<img src="<?php echo base_url(); ?>assets/img/logo.jpg" width="150" height="150" alt="AVATAR">
					</span>
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="<?php echo base_url('app/login_balita'); ?>">
							LOGIN BALITA
						</a> || 
						<a class="txt1" href="<?php echo base_url('dashboard/index'); ?>">
							DASHBOARD
						</a>
					</div>
