                            ...
                            <table id="lookup" class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								?>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url("admin/edit_data_imunisasi/$v->id_imunisasi"); ?>" class=" waves-effect waves-block">Edit</a></li>
                                        <li><a href="<?php echo base_url("admin/hapus_data_imunisasi/$v->id_imunisasi"); ?>" class=" waves-effect waves-block">Hapus</a></li>
                                        <li><a href="<?php echo base_url("admin/detail_data_imunisasi/$v->id_balita"); ?>" class=" waves-effect waves-block">Detail</a></li>
                                        <li><a href="<?php echo base_url("admin/sms_data_imunisasi/$v->id_imunisasi"); ?>" class=" waves-effect waves-block">Broadcast</a></li>
                                    </ul>
                                </div>
										</td>
                                    </tr>
