...
<div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
						...
						<!-- <button data-toggle="modal" data-target="#tambah" class="btn btn-success">Tambah Gizi</button> -->
                            ...
                            <table id="lookup" class="table table-bordered table-striped table-hover js-basic-example dataTable">
								...
								<?php foreach($tampil_gizi as $v) { ?>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url("balita/detail_data_gizi/$v->id_balita"); ?>" class=" waves-effect waves-block">Detail</a></li>
                                    </ul>
                                </div>
										</td>
                                    </tr>
