    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url("/balita/index"); ?>"><B>SISTEM INFORMASI E POSYANDU</B></a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
				...
				<!-- bagian naimpilin gambar/logo -->
                    <img src="<?php echo base_url(); ?>assets/img/logo.jpg" width="70" height="80" alt="User" /> <font color="white"><b>USER</b></font>
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url()?>balita/index">
                            <i class="fa fa-home" ><span>Home</span></i> 
                        </a>
                    </li>
				<li><a href="<?php echo base_url("balita/data_balita")?>"><i class="fa fa-file"> <span>Data Balita</span></i></a></li>
				<li><a href="<?php echo base_url("balita/data_imunisasi")?>"><i class="fa fa-file"> <span>Data Imunisasi</span></i></a></li>
				<li><a href="<?php echo base_url("balita/data_gizi")?>"><i class="fa fa-file"> <span>Data Vitamin</span></i></a></li>
                </ul>
            </div>
            <!-- #Menu -->
            <!-- bagian Footer menu -->
